...
namespace VidFluentAI.Data
{
    public static class ContextSeed
    {
        ...
        public static async Task SeedSuperAdminAsync(UserManager<ApplicationUser> userManager, RoleManager<IdentityRole> roleManager, string superAdminPassword)
        {
            //Seed Default User
